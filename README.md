...
**Agentic Engineer** specializing in Artificial Intelligence and AI-assisted development workflows, focusing on building efficient, scalable, and intelligent platforms. Passionate about solving complex problems through data-driven insights, vibe coding, and innovative software solutions. Alongside programming, I have a background in Art. My goal is to contribute to impactful projects and collaborate with developers around the world.

- 💼 Currently working at the **Ministry of Digital Technologies of the Republic of Uzbekistan**.
- 🌐 You can find me on my [Personal Website](https://vipshakh.uz).
- 📫 Let's connect! You can reach me via [LinkedIn](https://linkedin.com/in/shokirov/).

## 🌱 Currently learning
- **Advanced AI** development, data optimization techniques, and AI agents
- **AI Engineer** bachelor's student at PDPU 
